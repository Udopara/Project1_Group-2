            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    _statItem(user?.eventIds.length.toString() ?? '0', 'Events'),
                    Container(height: 30, width: 1, color: AppColors.cardBorder),
                    _statItem(user?.clubIds.length.toString() ?? '0', 'Communities'),
                    Container(height: 30, width: 1, color: AppColors.cardBorder),
                    _statItem(user?.metadata['connects']?.toString() ?? '0', 'Connects'),
                  ],
                ),
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _divider(),
                  _menuItem(context, Icons.person_outline_rounded, 'Account Settings', () {}),
                  _divider(),
